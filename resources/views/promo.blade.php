    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4" style="width: 34rem; border-radius: 20px; box-shadow: 2px 2px 16px 8px rgba(0,0,0,0.1); margin-right: 40px; margin-bottom: 40px; min-height: 450px;">
            <div class="thumbnail" style="border-style: none;">
                <img src="{{ asset('storage/' . $promo->gambar_promo) }}" style="width: 100%; height: 230px; background: url({{ $promo->gambar_promo }}) center / cover; border-radius: 20px; margin-top: 10px; margin-bottom: 10px;">
                <div class="caption">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img src="{{ asset('storage/' . $promo->gambar_promo) }}" style="width: 100%;height: 230px;background: url({{ $promo->gambar_promo }}) center / cover;position: relative;">
                        </div>
